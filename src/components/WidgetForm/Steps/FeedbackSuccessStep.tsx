  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-xl mt-8 text-secondary dark:text-secondary-dark">
          Agradecemos o feedback!
        </span>
        <button
          type="button"
          onClick={onFeedbackSent}
          className="transition py-2 px-6 mt-6 bg-surface-secondary dark:bg-surface-secondary-dark hover:bg-secondary text-primary dark:text-primary-dark rounded-md border-transparent text-sm leading-6 focus:ring-brand focus:ring-1 focus:outline-none"
        >
          Quero enviar outro
        </button>
      </div>
